...
const DropdownComponentItem = (props: IDropdownComponentItemProps): JSX.Element => {
    const { disabled, preSelected, selected, bold, color, children, isDiv, onClick, ...rest } =
        props;
...
const DropdownComponentContent = (props: IDropdownComponentContentProps): JSX.Element => {
    const { onLoad, reference, isTooltip, marginRight, marginLeft, bottom, ...rest } = props;
...
const DropdownComponent = (props: IDropdownComponentProps): JSX.Element => {
    ...
    const handleOnWindowScrollOrResize = (): void => {
        setOpen(false);
    ...
    React.useEffect(() => {
        ...
        DropdownComponentUtil.closeAllOpeningComps();
